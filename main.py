    ...
    def process_and_send():
        ...
        async def make_tts():
            ...
            if len(text) > 320:
                ...
                current_chunk = ""
                for word in words:
                    if len(current_chunk) + len(word) + 1 < 320:
                        current_chunk += " " + word
                    else:
            ...
            if len(chunks) == 1:
                ...
                for tf in temp_files:
                    try:
                        ...
                        logging.error(f"Error merging segment {tf}: {e}")
        ...
        try:
            ...
            if os.path.exists(final_filename):
                ...
                bot.send_message(message.chat.id, "Khalad ayaa dhacay: Faylka lagama helin.", reply_to_message_id=message.message_id)
        except Exception as e:
