...
def create_voice_keyboard():
    ...
    keyboard.add(KeyboardButton("Ubax"), KeyboardButton("Muuse"), KeyboardButton("Codka trend ga ah🔥"))
    return keyboard
...
@bot.message_handler(func=lambda m: m.text in ["Ubax", "Muuse", "Codka trend ga ah🔥"])
def set_voice(message):
    ...
    elif "Codka trend" in choice or "trend" in choice:
        voice_data = {"name": "so-SO-MuuseNeural", "label": "Codka trend ga ah🔥"}
